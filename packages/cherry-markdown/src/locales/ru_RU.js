...
export default {
  ...
  colorPickerRecentColors: 'Недавние цвета',
  colorPickerPresetColors: 'Предустановленные цвета',
  small: 'Маленький',
  medium: 'Средний',
  large: 'Большой',
  ...
  mathBlock: 'Блочная формула',
  shortcutKeySetting: 'Настройки горячих клавиш',
  editShortcutKeyConfigTip: 'Дважды щёлкните или нажмите Редактировать, чтобы изменить сочетание клавиш.',
  editingShortcutKeyConfigTip: 'Нажмите Enter для сохранения, Backspace для удаления добавленной клавиши',
  staticShortcutTip: 'Встроенные сочетания клавиш нельзя изменить',
  disabledShortcutTip: 'Сочетания клавиш в настоящее время отключены',
  ...
  mapChartLoading: 'Загрузка данных карты',
  mapChartLoadingTip: 'Если загрузка занимает много времени, пожалуйста, проверьте подключение к интернету',
  mapChartError: 'Ошибка загрузки данных карты',
  mapChartErrorTip: 'Пожалуйста, проверьте источник данных или подключение к интернету',
  mapChartRetry: 'Нажмите, чтобы перезагрузить',
  chartRenderError: 'Ошибка рендеринга графика',
  chartLibraryNotLoadedTip: 'Библиотека ECharts не загружена',
  radarData: 'Данные радара',
  scatterData: 'Данные скаттера',
  pieData: 'Распределение данных',
  heatmapData: 'Данные тепловой карты',
